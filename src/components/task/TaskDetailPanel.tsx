...
export function TaskDetailPanel({
  ...
  return (
    <Dialog open onClose={onClose} className="max-w-2xl max-h-[85vh] overflow-y-auto">
      <DialogHeader>
      ...
      <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            ...
            {isEditingDesc ? (
              <div
                ...
                className="mt-1 w-full min-h-[120px] max-h-64 overflow-y-auto rounded-lg border border-input bg-background px-3 py-2 text-sm text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring [&_img]:max-w-full [&_img]:rounded-lg"
              />
            ) : (
              <div
                key="desc-read"
                onClick={() => canEditTask && startEditingDesc()}
                className={`mt-1 min-h-[80px] rounded-lg border border-transparent px-3 py-2 text-sm text-foreground whitespace-pre-wrap break-words ${canEditTask ? 'hover:border-border transition-colors cursor-pointer' : ''}`}
              >
                {descSegments ? (
        ...
        <div className="space-y-3">
          <Select
            ...
            onChange={(e) => handleFieldUpdate('column_id', e.target.value)}
          />
          ...
          {canArchiveTask && (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-border px-3 py-2 text-sm text-muted-foreground hover:bg-muted transition-colors mt-2"
            >
              {task.archived ? (
                <>
          ...
          {canDeleteTask && (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-destructive/30 px-3 py-2 text-sm text-destructive hover:bg-destructive/10 transition-colors mt-2"
            >
